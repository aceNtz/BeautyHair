...
<head>
  ...
  <title>${companyInfo.name } | Partner</title>
            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="card-tools">
                  <a href="partner-form" class="btn btn-success">
                  ...
                  <c:forEach items="${partnerList }" var="partner">
	                  <tbody id="sort-list">
	                    <tr>
	                      ...
	                      <td class="text-center">
	                        <img src="${partner.image }" style="max-width: 80px;">
	                      </td>
	                      <td class="text-center">
	                        ${partner.important == true ? 'YES' : 'NO' }
	                      </td>
	                      
	                      <td class="text-center">
	                        <div class="btn-group"> 
	                          <a href="partner-update?id=${partner.id }" class="btn btn-info">
	                            <i class="fas fa-edit"></i>
	                          </a>
	                          <button type="button" class="btn btn-info" data-toggle="modal" data-target="#delete-modal-${partner.id }">
	                            <i class="fas fa-trash"></i>
	                          </button>
	                        </div>
	                      </td>
	                    </tr>
	                    <div class="modal fade" id="delete-modal-${partner.id }">
					      <div class="modal-dialog">
					        <div class="modal-content">
					          ...
					          <div class="modal-body">
					            <p>Are you sure you want to delete selected partner?</p>
					            <strong></strong>
					          </div>
					          <div class="modal-footer justify-content-between">
					            <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
					            <a href="partner-delete?id=${partner.id }" class="btn btn-danger">Delete</a>
					          </div>
					        </div>
					        <!-- /.modal-content -->
					      </div>
