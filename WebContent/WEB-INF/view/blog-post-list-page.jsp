...
<head>
  ...
  <title>${companyInfo.name } | Blog Post</title>
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">
	            <c:if test="${pageId == 1 }">All Blog Post List</c:if>
	            <c:if test="${pageId == 0 }">My Blog Post List</c:if>
              </li>
            </ol>
          </div>
        </div>
					      ...
					      <div class="modal-dialog">
					        <div class="modal-content">
					          ...
					          <div class="modal-footer justify-content-between">
					            ...
					            <a href="blog-post-delete?id=${blogPost.id }&pageId=${pageId}" class="btn btn-danger">Delete</a>
					          </div>
					        </div>
					        <!-- /.modal-content -->
					      </div>
