...
<html lang="en">
  <head>
    <title>${companyInfo.name } | Blog</title>
    <meta charset="utf-8">
      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-8 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
            ...
            <p class="breadcrumbs" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><span class="mr-2"><a href="index">Home</a></span> <span>Blog</span></p>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="row d-flex">
          ...
          <div class="col-md-4 d-flex ftco-animate">
              ...
              <div class="text py-4 d-block">
                  ...
                  <div>${blog.author.name } ${blog.author.surname }</div>
                  <div><a class="meta-eye"><span class="icon-eye"></span> ${blog.viewCount }</a></div>
                </div>
          ...
          <div class="col text-center">
            <div class="block-27">
               <ul>
                ...
                <c:if test="${pageNum > 0 }">
                  <li><a href="blog?pageNum=${pageNum - 1 }">&lt;</a></li>
                </c:if>
                
                <c:if test="${pageNum <= 0 }">
                  <li><a href="blog?pageNum=0">&lt;</a></li>
                </c:if>
                
                <c:forEach begin="0" end="${numberOfPages - 1 }" var="i">
                  <li class="${i == pageNum ? 'page-link active' : 'page-link' }"><a href="blog?pageNum=${i }"><span>${i+1 }</span></a></li>
                </c:forEach>                
                ...
                <c:if test="${pageNum + 1 >= numberOfPages }">
                  <li><a href="blog?pageNum=${numberOfPages - 1}">&gt;</a></li>
                </c:if>
