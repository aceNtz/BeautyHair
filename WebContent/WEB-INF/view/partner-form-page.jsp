        ...
        <div class="row">
          <div class="col-md-6">
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form:form action="partner-save" modelAttribute="partner" role="form">
              <form:hidden path="id"/>
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <label>Link</label>
                    <form:input type="text" class="form-control" placeholder="Add Link" path="link"/>
                    <form:errors path="link" cssClass="text-danger"></form:errors>
                  </div>
                  <div class="form-group">
                    <label>Image</label>
