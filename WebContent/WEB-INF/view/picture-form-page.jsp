        ...
        <div class="row">
          <div class="col-md-6">
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form:form action="picture-save" modelAttribute="picture" role="form">
              <form:hidden path="id"/>
              <form:hidden path="date"/>
                <div class="card-body">
                  <div class="form-group">
                    <label>Image</label>
                    <form:input type="text" class="form-control" placeholder="Add Picture Link" path="image"/>
                    <form:errors path="image" cssClass="text-danger"></form:errors>
                  </div>
                  <div class="custom-control custom-checkbox">
                    <form:checkbox class="custom-control-input" id="customCheckbox1" path="visible"/>
                    <label for="customCheckbox1" class="custom-control-label">Visible?</label>
                  </div>
                  <div class="custom-control custom-checkbox">
